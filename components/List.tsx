...
export default function List() {
    return(
        <>
        <div className="mx-2">
        <div className="bg-gray-200 h-10 flex justify-between px-5 items-center max-w-7xl sm:mx-auto -mb-4 border rounded">
        <h3 className="text-sm">Amil linha selecionada</h3>    
        <h3 className="text-sm">Plano adesão</h3>    
        </div>  
        <div className="sm:flex items-center bg-white dark:bg-gray-800 mt-4 mx-auto max-w-7xl rounded  shadow mb-4">
            ...
            <div className="block bg-gray-100 p-3 my-1 rounded">
            <PlanosLine />
            <PlanosLine />
            <PlanosLine />
            <PlanosLine />
